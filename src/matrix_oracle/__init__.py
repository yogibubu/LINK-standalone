...
_LAZY_EXPORTS = {
    ...
    **_exports(
        "coordinate_atlas",
        "ORACLE_COORDINATE_ATLAS_BUILDER ORACLE_COORDINATE_ATLAS_POLICY_ID ORACLE_COORDINATE_ATLAS_POLICY_VERSION build_exploration_coordinate_atlas_contract build_minimum_coordinate_atlas_contract build_transition_state_coordinate_atlas_contract coordinate_atlas_policy_manifest write_exploration_coordinate_atlas_contract write_minimum_coordinate_atlas_contract write_transition_state_coordinate_atlas_contract",
    ),
    **_exports(
